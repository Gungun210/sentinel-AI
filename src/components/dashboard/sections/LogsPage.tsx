  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold mb-2">Log Analysis</h1>
          <p className="text-muted-foreground">Analyze logs with AI-powered insights and pattern detection</p>
        </div>
        <button
          onClick={analyzeLogs}
        ...
        <>
          ...
          <div className="grid grid-cols-4 gap-6 mb-6">
            ...
            <div className="card pointer-events-auto">
              ...
              <div className="text-2xl font-bold">{logs.filter(l => l.level === "warn").length}</div>
            </div>
            <div className="card pointer-events-auto">
              <div className="flex items-center gap-3 mb-2">
              ...
              <div className="text-2xl font-bold">{logs.filter(l => l.level === "info").length}</div>
            </div>
          </div>
            ...
            <div className="space-y-2 max-h-[500px] overflow-y-auto">
              {filteredLogs.map((log, index) => (
                <motion.div
                  ...
                  className={`p-4 rounded-lg border cursor-pointer transition-all hover:scale-[1.01] ${getLevelColor(log.level)} pointer-events-auto`}
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-2">
                        <span className="text-xs font-medium uppercase px-2 py-1 rounded-full">{log.level}</span>
            ...
            >
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="mt-3">
                  ...
                  <p className="mt-1 p-3 bg-input rounded-lg font-mono text-xs">{selectedLog.message}</p>
                </div>
                {selectedLog.metadata && (
                  <div className="mt-3">
                    <span className="text-muted-foreground">Metadata:</span>
                    <pre className="mt-1 p-3 bg-input rounded-lg text-xs overflow-x-auto">
